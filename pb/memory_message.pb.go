...
type Memory struct {
    ...
    Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=xiusl.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
    ...
    0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xad, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12,
    ...
    0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x78, 0x69, 0x75, 0x73, 0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f,
    0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x55, 0x6e, 0x69, 0x74, 0x52, 0x04,
    ...
    0x54, 0x45, 0x10, 0x06, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
    0x74, 0x6f, 0x33,
}
...
var file_memory_message_proto_goTypes = []interface{}{
    (Memory_Unit)(0), // 0: xiusl.pcbook.Memory.Unit
    (*Memory)(nil),   // 1: xiusl.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
    0, // 0: xiusl.pcbook.Memory.unit:type_name -> xiusl.pcbook.Memory.Unit
